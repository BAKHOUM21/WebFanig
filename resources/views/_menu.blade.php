    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse d-flex" id="navbarNavDropdown">
            <ul class="navbar-nav m-auto ">
                <li class="nav-item">
                    <a class="nav-link active menu fs-5" style="color: rgb(210,107,44)" aria-current="page"
                        href="{{route('home')}} "><strong>Home</strong> </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown fs-5">
                    <a class="nav-link dropdown-toggle" style="color: rgb(210,107,44)" href="#"
